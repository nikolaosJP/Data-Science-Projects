...
export declare const useMouseEnterItemDispatch: <T extends TooltipPayloadType>(onMouseEnterFromProps: ActivateTooltipAction<T> | undefined, dataKey: DataKey<any> | undefined) => (data: TooltipTriggerInfo<T>, index: number) => (event: React.MouseEvent<SVGElement>) => void;
...
export declare const useMouseClickItemDispatch: <T extends TooltipPayloadType>(onMouseClickFromProps: ActivateTooltipAction<T> | undefined, dataKey: DataKey<any> | undefined) => (data: TooltipTriggerInfo<T>, index: number) => (event: React.MouseEvent<SVGElement>) => void;
export {};
